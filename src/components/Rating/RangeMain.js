...
export default class Range extends Component {
  ...
  handleChange = (e) => {
    ...
    if (value_itog > 0.1) {
      this.setState({ active_1: true });
    }
    if (value_itog < 0.1) {
      this.setState({ active_1: false });
    }

    if (value_itog > 1.2) {
      this.setState({ active_2: true });
    }
    if (value_itog < 1.2) {
      this.setState({ active_2: false });
    }

    if (value_itog > 2.5) {
      this.setState({ active_3: true });
    }
    if (value_itog < 2.5) {
      this.setState({ active_3: false });
    }

    if (value_itog > 3.5) {
      this.setState({ active_4: true });
    }
    if (value_itog < 3.5) {
      this.setState({ active_4: false });
    }

    if (value_itog > 4.5) {
      this.setState({ active_5: true });
    }
    if (value_itog < 4.5) {
      this.setState({ active_5: false });
    }

    if (value_itog > 0.1 && value_itog < 1) {
      this.setState({ test: 1 });
    }
    if (value_itog > 1.2 && value_itog < 2) {
      this.setState({ test: 2 });
    }
    if (value_itog > 2.5 && value_itog < 3) {
      this.setState({ test: 3 });
    }
    if (value_itog > 3.5 && value_itog < 4) {
      this.setState({ test: 4 });
    }
    if (value_itog > 4.5 && value_itog < 5) {
